...
class Setting extends Model
{
    ...
    /**
     * Operating hours for storefront.
     *
    ...
    public static function isStoreOpen(?Carbon $now = null): bool
    {
        ...
        $start = Carbon::createFromFormat('H:i', $hours['start'], 'Asia/Jakarta')
            ->setDateFrom($now);
        $end = Carbon::createFromFormat('H:i', $hours['end'], 'Asia/Jakarta')
            ->setDateFrom($now);
    ...
    /**
     * Public store identity used in customer/admin views.
     *
