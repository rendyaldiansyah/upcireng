        ...
        <div class="grid gap-6 sm:gap-8 lg:grid-cols-[1fr_1.15fr] lg:items-center">
                    ...
                    <div class="space-y-4">
                        ...
                        @foreach($features as $f)
                            <div class="flex items-start gap-3.5">
                                <span class="mt-0.5 shrink-0 text-lg">{{ $f['icon'] }}</span>
                                <div>
                                    <p class="text-sm font-bold text-white sm:text-base">{{ $f['title'] }}</p>
                                    <p class="text-xs text-white/65 sm:text-sm">{{ $f['desc'] }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-xl sm:rounded-3xl sm:p-8 lg:p-10">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-11 pr-4 text-sm font-semibold text-slate-700 outline-none transition focus:border-brand-400 focus:bg-white focus:ring-2 focus:ring-brand-100 sm:py-3.5 @error('name') border-rose-300 bg-rose-50 @enderror"
                                required
                            >
                        </div>
                        @error('name')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-11 pr-4 text-sm font-semibold text-slate-700 outline-none transition focus:border-brand-400 focus:bg-white focus:ring-2 focus:ring-brand-100 sm:py-3.5 @error('phone') border-rose-300 bg-rose-50 @enderror"
                                required
                            >
                        </div>
                        @error('phone')
                ...
                <p class="mt-5 text-center text-xs text-slate-400">
                    ...
                    <a href="{{ route('home') }}" class="font-bold text-brand-500 hover:text-brand-600 transition">Kembali ke Menu</a>
                </p>
            </div>
