...
<div class="container">
    ...
    <div class="body">
        <p class="greeting">Halo, <strong>{{ $order->customer_name }}</strong>!</p>
                ...
                <tr>
                    <td>
                        ...
                        @if(!empty($item['variant']))
                            <br><small style="color:#9ca3af">{{ $item['variant'] }}</small>
                        @endif
                    </td>
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                ...
                <span class="value" style="text-align:right;max-width:300px">{{ $order->delivery_address }}</span>
            </div>
        </div>
    ...
    <div class="footer">
        ...
        <p>© {{ date('Y') }} UP Cireng. All rights reserved.</p>
    </div>
</div>
</body>
</html>