    ...
    <div style="max-width:640px;margin:0 auto;padding:24px;">
        <div style="background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 20px 40px rgba(239,68,68,0.12);">
            ...
            <div style="padding:32px;">
                ...
                <p>Pesanan dengan reference <strong>{{ $order->reference }}</strong> telah dibatalkan di sistem.</p>
                ...
                <div style="margin-top:24px;border:1px solid #fecaca;border-radius:20px;padding:20px;background:#fff1f2;">
                    ...
                    <p style="margin:0 0 8px;"><strong>Total:</strong> {{ $order->formatPrice() }}</p>
                    <p style="margin:0;"><strong>Alasan:</strong> {{ $order->cancel_reason ?: 'Tidak ada alasan tambahan.' }}</p>
                </div>
