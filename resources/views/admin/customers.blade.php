        ...
        <div class="mb-8 grid grid-cols-3 gap-4">
            ...
            @foreach($statCards as $sc)
                <div class="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
                    <p class="text-xs font-bold uppercase tracking-wider text-slate-400">{{ $sc['label'] }}</p>
                    <p class="mt-2 text-3xl font-black {{ $sc['color'] }}">{{ $sc['value'] }}</p>
                </div>
            @endforeach
        </div>
                        ...
                        @forelse($customers as $customer)
                            <tr class="group hover:bg-slate-50/50 transition">
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[11px] text-slate-400">#{{ $customer->id }}</p>
                                        </div>
                                    </div>
                                </td>
                                {{-- Email --}}
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <p class="text-[11px] text-slate-400">{{ $customer->created_at->diffForHumans() }}</p>
                                </td>
                                {{-- Actions --}}
                                <td class="px-5 py-4">
