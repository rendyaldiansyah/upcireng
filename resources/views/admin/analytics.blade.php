    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        :root {
            ...
            --shadow-lg: 0 10px 40px rgba(15,23,42,0.10), 0 2px 8px rgba(15,23,42,0.05);
        }
        ...
        /* ── Progress ── */
        .prog-track {
            height: 4px; background: var(--bg); border-radius: 999px; overflow: hidden; margin-top: 6px;
        }
        .prog-fill {
            height: 100%; border-radius: 999px; transition: width 0.7s cubic-bezier(0.34,1.56,0.64,1);
        }

        /* ── Funnel ── */
        .funnel-row { display: flex; align-items: center; gap: 12px; }
        .funnel-bar-wrap {
            flex: 1; height: 28px; background: var(--bg); border-radius: 8px; overflow: hidden; position: relative;
        }
        .funnel-fill {
            height: 100%; border-radius: 8px; transition: width 0.8s cubic-bezier(0.34,1.56,0.64,1);
        ...
        .funnel-pct {
            ...
            font-size: 10px; font-weight: 600; color: var(--text-3); pointer-events: none;
        }
        ...
        .order-row {
            ...
            padding: 10px 12px; border-radius: var(--r-inner); background: var(--bg);
        ...
        .send-btn:hover { transform: translateY(-1px); box-shadow: 0 6px 18px rgba(5,150,105,0.35); }
        ...
        .empty-state {
            ...
            justify-content: center; padding: 36px 0; gap: 8px;
        }
        .empty-state .empty-icon { font-size: 32px; opacity: 0.4; }
        .empty-state p { font-size: 12px; font-weight: 600; color: var(--text-3); margin: 0; }
