    ...
    <div class="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
        <div class="rounded-[2rem] bg-white p-8 shadow-xl shadow-brand-500/20">
            <div class="flex items-start justify-between gap-4">
                ...
                <a href="<?php echo e(route('testimonial.index')); ?>" class="rounded-full border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 transition hover:border-brand-300 hover:text-brand-600">
                    ← Kembali
                </a>
            </div>
            ...
            <form action="<?php echo e(route('testimonial.store')); ?>" method="POST" class="mt-8 space-y-5">
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="customer_name" value="<?php echo e(old('customer_name', $user?->name)); ?>" class="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none transition focus:border-brand-400 focus:ring-4 focus:ring-brand-100" required>
                    </div>
                    <div>
                        <label class="mb-2 block text-sm font-semibold text-slate-700">Email</label>
                        <input type="email" name="customer_email" value="<?php echo e(old('customer_email', $user?->email)); ?>" class="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none transition focus:border-brand-400 focus:ring-4 focus:ring-brand-100" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="message" rows="6" class="w-full rounded-[1.5rem] border border-slate-200 px-4 py-3 outline-none transition focus:border-brand-400 focus:ring-4 focus:ring-brand-100" required placeholder="Bagikan pengalaman Anda berbelanja dengan kami..."><?php echo e(old('message')); ?></textarea>
                </div>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\UP Cireng\upcireng\resources\views\testimonial\create.blade.php ENDPATH**/ ?>