    ...
    <main class="px-4 py-6 sm:px-5 sm:py-8 lg:px-8 xl:px-10">
        ...
        <section class="mb-10 sm:mb-12 lg:mb-16 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-brand-50 via-white to-brand-50/50 p-5 sm:p-8 lg:p-12 shadow-lg border border-brand-100/50 hover:border-brand-200/50 transition-all duration-500" data-animate="fade-in-up" data-delay="100">
            <div class="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div class="flex flex-wrap gap-2 sm:gap-3 xl:justify-end">
                    <a href="<?php echo e(route('admin.products.index')); ?>" class="inline-flex items-center justify-center gap-2 rounded-xl sm:rounded-2xl border-2 border-slate-200 bg-white px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-bold text-slate-800 transition-all duration-300 hover:border-brand-400 hover:shadow-2xl hover:-translate-y-1 hover:bg-brand-50 min-h-11 sm:min-h-12">
        ...
        <section class="grid gap-4 sm:gap-5 mb-10 sm:mb-12 lg:mb-16 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5" data-animate="fade-in-up" data-delay="200">
            <div class="group rounded-2xl sm:rounded-3xl bg-white p-5 sm:p-6 shadow-panel border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
                ...
                <p class="text-2xl sm:text-3xl font-black text-ink-950 leading-tight break-words"><?php if($totalRevenue ?? false): ?>Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?><?php else: ?> Rp 0 <?php endif; ?></p>
            ...
            <div class="group rounded-2xl sm:rounded-3xl bg-white p-5 sm:p-6 shadow-panel border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
                ...
                <p class="text-2xl sm:text-3xl font-black text-ink-950"><?php echo e($totalOrders ?? 0); ?></p>
            ...
            <div class="group rounded-2xl sm:rounded-3xl bg-white p-5 sm:p-6 shadow-panel border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
                ...
                <p class="text-2xl sm:text-3xl font-black text-amber-700"><?php echo e($pendingOrders ?? 0); ?></p>
            ...
            <div class="group rounded-2xl sm:rounded-3xl bg-white p-5 sm:p-6 shadow-panel border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 sm:col-span-2 lg:col-span-1">
                ...
                <p class="text-2xl sm:text-3xl font-black text-sky-700"><?php echo e($pendingTestimonials ?? 0); ?></p>
            ...
            <div class="space-y-6 lg:space-y-8" data-animate="fade-in-up" data-delay="300">
                ...
                <div class="rounded-2xl sm:rounded-3xl bg-white p-5 sm:p-6 lg:p-8 shadow-panel border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 sm:mb-8">
                        ...
                        <a href="<?php echo e(route('admin.products.index')); ?>" class="text-brand-500 font-bold hover:text-brand-600 text-sm whitespace-nowrap">
                            Lihat Semua →
                        </a>
                    </div>
                ...
                <div class="rounded-2xl sm:rounded-3xl bg-gradient-to-br from-brand-500 via-brand-600 to-brand-700 p-5 sm:p-6 lg:p-8 shadow-panel border border-brand-400/30 hover:shadow-2xl hover:shadow-brand-500/20 hover:-translate-y-2 transition-all duration-500">
                    ...
                    <div class="space-y-3">
                        <a href="<?php echo e(route('admin.products.create')); ?>" class="block w-full rounded-2xl bg-white/95 hover:bg-white px-5 py-3.5 text-center font-bold text-brand-700 text-sm sm:text-base transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
        ...
        <section class="mt-14 sm:mt-16 lg:mt-20" data-animate="fade-in-up" data-delay="400">
            <div class="flex flex-col gap-4 sm:gap-6 sm:flex-row sm:items-center sm:justify-between mb-8 sm:mb-10 lg:mb-12">
                ...
                <a href="<?php echo e(route('admin.orders')); ?>" class="inline-flex items-center justify-center gap-2 rounded-2xl border-2 border-slate-200 bg-white px-5 sm:px-6 lg:px-8 py-3 sm:py-4 text-sm sm:text-base lg:text-lg font-bold text-slate-800 hover:border-brand-400 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="grid gap-5 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
                <?php if(!empty($recentOrders) && is_array($recentOrders)): ?>
                    <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('admin.orders')); ?>?reference=<?php echo e(urlencode($order->reference ?? '')); ?>" class="group relative rounded-2xl sm:rounded-3xl bg-white shadow-panel border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden block h-full">
                                ...
                                <div class="relative z-10 flex-1 flex flex-col">
                                    <div class="flex items-start justify-between gap-3 mb-4 sm:mb-6">
                                        <div class="flex-1 min-w-0 pr-2">
                                            ...
                                            <p class="text-lg sm:text-2xl lg:text-3xl font-black text-brand-600 truncate"><?php echo e($order->reference ?? 'N/A'); ?></p>
                                        </div>

                                        <span class="px-2.5 sm:px-3 md:px-4 py-1 sm:py-2 rounded-xl sm:rounded-2xl text-[10px] sm:text-xs font-bold <?php echo e($order->status_color ?? 'text-slate-600'); ?> bg-opacity-20 whitespace-nowrap flex-shrink-0">
                                    ...
                                    <div class="space-y-3 sm:space-y-5 mb-6 sm:mb-8 flex-1">
                                        <div>
                                            ...
                                            <p class="font-black text-slate-900 text-sm sm:text-base truncate"><?php echo e($order->customer_name ?? 'N/A'); ?></p>
                                            <p class="text-xs sm:text-sm text-slate-600 mt-1 truncate"><?php echo e($order->customer_phone ?? '-'); ?></p>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                                            <div class="rounded-xl sm:rounded-2xl bg-slate-50 p-3 sm:p-4">
                                                ...
                                                <p class="text-lg sm:text-2xl font-black text-ink-950 mt-1"><?php echo e(is_array($order->items_summary ?? null) ? count($order->items_summary) : 0); ?></p>
                                            </div>

                                            <div class="rounded-xl sm:rounded-2xl bg-slate-50 p-3 sm:p-4">
                                                <p class="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-slate-400">Total</p>
                                                <p class="text-sm sm:text-lg font-black text-ink-950 mt-1 truncate"><?php echo e(method_exists($order, 'formatPrice') ? $order->formatPrice() : 'Rp 0'); ?></p>
                                            </div>
                                        </div>
                                    </div>
