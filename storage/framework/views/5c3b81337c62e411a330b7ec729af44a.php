<?php $__env->startSection('title', 'Login & Daftar | UP Cireng'); ?>
    ...
    <div class="mx-auto grid max-w-7xl gap-6 sm:gap-8 lg:grid-cols-[1fr_1.05fr]">
                ...
                <div class="space-y-3 sm:space-y-4">
                    ...
                    <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-sm font-bold text-white sm:text-base"><?php echo e($feature['title']); ?></p>
                                <p class="text-xs text-white/80 sm:text-sm"><?php echo e($feature['desc']); ?></p>
                            </div>
                        </div>
        ...
        <div class="grid gap-5 sm:gap-6">
            ...
            <section class="rounded-2xl border border-white/80 bg-white p-6 shadow-lg sm:rounded-3xl sm:p-8 lg:p-10">
                ...
                <form action="<?php echo e(route('auth.register')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
