                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-4 flex justify-center">
                                    <?php if(file_exists(public_path('images/qris.png'))): ?>
                                        <img src="<?php echo e(asset('images/qris.png')); ?>" alt="QRIS Code" class="w-40 h-40 rounded-xl border-2 border-orange-300 shadow-lg">
                                    <?php else: ?>
