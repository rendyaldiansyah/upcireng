                ...
                <article class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-lg shadow-slate-200/70">
                    ...
                    <div class="mt-5 grid gap-4 md:grid-cols-3">
                        ...
                        <div class="rounded-[1.5rem] bg-slate-50 p-4">
                            ...
                            <p class="mt-1 text-sm text-slate-600"><?php echo e(strtoupper($order->payment_method)); ?></p>
                        </div>
                        <div class="rounded-[1.5rem] bg-slate-50 p-4">
                            <p class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Sync Log</p>
                            <p class="mt-3 text-sm font-semibold text-slate-900"><?php echo e($order->sync_status_label); ?></p>
                            <?php if($order->sync_error): ?>
                                <p class="mt-2 text-xs leading-6 text-rose-600"><?php echo e($order->sync_error); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
