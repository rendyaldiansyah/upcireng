...
<div class="wrapper">
    ...
    <div class="header">
        ...
        <span class="badge">#<?php echo e($order->reference); ?></span>
    </div>

    <div class="body">

        <p class="greeting">
            Halo, <strong><?php echo e($order->customer_name); ?></strong>! 👋<br>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <?php if($item['variant']): ?>
                            <div class="product-variant"><?php echo e($item['variant']); ?></div>
                        <?php endif; ?>
                    </td>
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                ...
                <span class="value"><span class="status-badge"><?php echo e($order->status_label); ?></span></span>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span class="value"><?php echo e($order->created_at->translatedFormat('d F Y, H:i')); ?></span>
            </div>
        </div>

        <?php if($order->notes): ?>
        <div class="note-box">
            📝 <strong>Catatan:</strong> <?php echo e($order->notes); ?>

        </div>
        <?php endif; ?>

        <div class="footer-cta">
            <a href="<?php echo e(route('order.show', $order)); ?>" class="btn">Lihat Detail Pesanan →</a>
        </div>
