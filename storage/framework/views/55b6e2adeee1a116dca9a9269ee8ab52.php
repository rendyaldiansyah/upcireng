        ...
        <div style="background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 20px 40px rgba(15,23,42,0.08);">
            ...
            <div style="padding:32px;">
                <div style="padding:18px 20px;border-radius:18px;background:#fff7ed;border:1px solid #fdba74;">
                    <p style="margin:0 0 6px;"><strong>Reference:</strong> <?php echo e($order->reference); ?></p>
                    <p style="margin:0 0 6px;"><strong>Pelanggan:</strong> <?php echo e($order->customer_name); ?></p>
                    <p style="margin:0 0 6px;"><strong>Kontak:</strong> <?php echo e($order->customer_phone); ?> | <?php echo e($order->customer_email); ?></p>
                    <p style="margin:0;"><strong>Total:</strong> <?php echo e($order->formatPrice()); ?></p>
                </div>
                ...
                <p style="margin-top:24px;"><strong>Alamat:</strong> <?php echo e($order->delivery_address); ?></p>
                <?php if($order->notes): ?>
                    <p style="margin-top:12px;"><strong>Catatan:</strong> <?php echo e($order->notes); ?></p>
                <?php endif; ?>

                <div style="margin-top:28px;">
                    <a href="<?php echo e(route('admin.orders')); ?>" style="display:inline-block;padding:14px 22px;border-radius:999px;background:#0f172a;color:#ffffff;text-decoration:none;font-weight:bold;">
                        Buka daftar pesanan
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\Users\user\Desktop\UP Cireng\upcireng\resources\views\emails\admin_order_notification.blade.php ENDPATH**/ ?>